...
public record KullanicilarDTO(Short id, Byte durum, Byte tipi, String kodu, String adi, String sifresi, Short subeId,
		Short varsayilanKasaId, Byte maxTaksitSayisi, Byte otomatikTaksitSayisi, Boolean karZararGorur,
